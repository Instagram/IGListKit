...
- Added `UICollectionView`s `isPrefetchingEnabled` to the `IGListAdapter` debug description. [BasThomas](https://github.com/BasThomas) [(#726)](https://github.com/Instagram/IGListKit/pull/726)
