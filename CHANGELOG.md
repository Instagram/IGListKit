...
- Added GitHub workflow which can automatically create GitHub release and attach binary framework for Carthage users so they can pull it instead of building from source.
