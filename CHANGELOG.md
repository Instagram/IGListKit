...
- Added type information in places that were declared as `id` but took an `id<IGListDiffable>`. [Paddy O'Brien](https://github.com/tapi) [(#1011)](https://github.com/Instagram/IGListKit/pull/1011)
