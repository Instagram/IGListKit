...
final class MonthSectionController: IGListDiffingSectionController, IGListDiffingSectionControllerDataSource, IGListDiffingSectionControllerSelectionDelegate {
    ...
    // MARK: IGListDiffingSectionControllerDataSource
    
    func sectionController(_ sectionController: IGListDiffingSectionController, viewModelsFor object: Any) -> [IGListDiffable] {
    ...
    func sectionController(_ sectionController: IGListDiffingSectionController, cellForViewModel viewModel: Any, at index: Int) -> UICollectionViewCell {
    ...
    // MARK: IGListDiffingSectionControllerSelectionDelegate
    
    func sectionController(_ sectionController: IGListDiffingSectionController, didSelectItemAt index: Int, viewModel: Any) {
