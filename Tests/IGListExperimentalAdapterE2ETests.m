...
/// Equivalent of `IGListAdapterE2ETests` to test the new `IGListExperimentalAdapterUpdater`
@interface IGListExperimentalAdapterE2ETests : IGListTestCase
@end

@implementation IGListExperimentalAdapterE2ETests
...
- (void)test_whenSectionControllerReloads_withPreferItemReload_thatCountsAreUpdated {
    ...
    [(IGListExperimentalAdapterUpdater *)self.adapter.updater setPreferItemReloadsForSectionReloads:YES];
...
- (void)test_whenPerformingUpdates_withoutSettingDataSource_thatCompletionBlockExecutes {
    ...
    IGListAdapter *adapter = [[IGListAdapter alloc] initWithUpdater:[IGListExperimentalAdapterUpdater new] viewController:nil];
...
- (void)test_whenAdaptersSwapCollectionViews_thatOldAdapterDoesntUpdateOldCollectionView {
    IGListAdapter *adapter1 = [[IGListAdapter alloc] initWithUpdater:[IGListExperimentalAdapterUpdater new] viewController:nil];
    ...
    IGListAdapter *adapter2 = [[IGListAdapter alloc] initWithUpdater:[IGListExperimentalAdapterUpdater new] viewController:nil];
...
- (void)test_whenReleasingObjects_thatAssertDoesntFire {
    ...
    @autoreleasepool {
        IGListExperimentalAdapterUpdater *updater = [[IGListExperimentalAdapterUpdater alloc] init];
...
- (void)test_whenPerformingBatchSectionUpdate_thatTransactionObjectsGetsDeallocated {
    ...
    // It should crash if the updater isn't a IGListExperimentalAdapterUpdater.
    // Once IGListExperimentalAdapterUpdater ships, it will be renamed to IGListAdapterUpdater.
