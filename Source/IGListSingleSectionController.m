...
- (UICollectionViewCell *)cellForItemAtIndex:(NSInteger)index {
    ...
    id cell;
    if (self.nibName) {
        cell = [self.collectionContext dequeueReusableCellFromNibName:self.nibName
                                                               bundle:self.bundle
                                                 forSectionController:self
                                                              atIndex:index];
    } else {
        cell = [self.collectionContext dequeueReusableCellOfClass:self.cellClass forSectionController:self atIndex:index];
    }
